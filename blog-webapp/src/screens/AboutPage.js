...
const AboutPage = () => {
  ...
  <div style={{ width: '50%', textAlign: 'justify' }}>
      ...
      <h2 id="mission" style={{ textAlign: 'center', marginTop:'30px', marginBottom: '30px'}}>Sứ mệnh </h2>
      <div style={{ display: 'flex', justifyContent: 'center' }}>
  <div style={{ width: '50%', textAlign: 'justify' }}>
        <p>
      ...
      <h2 id="exp" style={{ textAlign: 'center', marginTop:'30px', marginBottom: '30px'}}>Năng lực</h2>
      <div style={{ display: 'flex', justifyContent: 'center' }}>
  <div style={{ width: '50%', textAlign: 'justify' }}>
        <p>
      ...
      <h2 id="unique" style={{ textAlign: 'center', marginTop:'30px', marginBottom: '30px'}}>Điểm độc nhất </h2>
      <div style={{ display: 'flex', justifyContent: 'center' }}>
  <div style={{ width: '50%', textAlign: 'justify' }}>
        <p>
      ...
      <h2 id="overview" style={{ textAlign: 'center', marginTop:'30px', marginBottom: '30px'}}>Tổng quan</h2>
      <div style={{ display: 'flex', justifyContent: 'center' }}>
  <div style={{ width: '50%', textAlign: 'justify' }}>
        <p>
      ...
      <h2 id="community" style={{ textAlign: 'center', marginTop:'30px', marginBottom: '30px'}}>Mạng xã hội </h2>
