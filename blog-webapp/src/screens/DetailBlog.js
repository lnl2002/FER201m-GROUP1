...
//               {feedback.map((u) => (
//                   <tr key={u.id}>
//                      <td>{user.map((s) => (s.id === u.userId ? s.name :""))}</td>
//                     <td>{u.content}</td>
//                     <td>{u.rate} <span>&#9733;</span></td>
...
//                 </h5>
//                 <h5 style={{ color: 'red' }}> rate : {feedback.map((u) => (u.blogId === p.id ? u.rate :""))} <span>&#9733;</span> </h5>
//             </div> */}
//             </Table>
//             </Col>
//         </Row>
